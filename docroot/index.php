...
<body>
  ...
  <form id='controls' method='GET'>
    <ul>
      ...
      <li class='break'><a href='<?php echo parse_url($_SERVER["REQUEST_URI"], PHP_URL_PATH); ?>'>Reset</a>&nbsp; <a href='#' id='clearform'>Clear</a>&nbsp; <a href='https://www.weather.gov/documentation/services-web-api' target='_new'>API&nbsp;Docs</a><br/><a href='https://github.com/clockspot/nws-api-demo' target='_new'>Source&nbsp;on&nbsp;GitHub</a></li>
    </ul>
  </form>
  <div id='results'><?php
